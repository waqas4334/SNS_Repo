      ...
      {chartLoading ? (
        ...
        <View style={{flex:1,backgroundColor:'#fff'}}>
          <View style={{flexDirection:'row',justifyContent:'space-around'}}>
            {selectedTypeValue ===   'Average Ph Chart' ? (
              ...
              <Text>Avergae Ph</Text>
              </View>
            ): selectedTypeValue ===   'Average TDS Chart' ?(
              <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:hp('4%')}}>
                 <Icon name='dot-single' size={30} color='#2196f3'/>
              <Text style={{alignItems:'center',fontWeight:'bold'}}>Y-axis:</Text>
              <Text>Average TDS</Text>
              </View> 
            ):selectedTypeValue ===    'Aerator Status Chart' ?(
              <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:hp('4%')}}>
                 <Icon name='dot-single' size={30} color='#2196f3'/>
              <Text style={{alignItems:'center',fontWeight:'bold'}}>Y-axis:</Text>
              <Text>Aerator Status Count</Text>
              </View>            
            ):selectedTypeValue ===   'Average Temperature Chart' ?(
              <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:hp('4%')}}>
                 <Icon name='dot-single' size={30} color='#2196f3'/>
              <Text style={{alignItems:'center',fontWeight:'bold'}}>Y-axis:</Text>
              <Text>Average Temperature</Text>
              </View>            
            ):selectedTypeValue ===   'Motor Status Chart' ?(
              <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:hp('4%')}}>
                 <Icon name='dot-single' size={30} color='#2196f3'/>
              <Text style={{alignItems:'center',fontWeight:'bold'}}>Y-axis:</Text>
              <Text>Average Motor Count</Text>
              </View>            
            ):selectedTypeValue ===   'Dissolved Oxygen Chart' ?(
              <View style={{flexDirection:'row',alignItems:'center',justifyContent:'center',marginTop:hp('4%')}}>
                 <Icon name='dot-single' size={30} color='#2196f3'/>
              <Text style={{alignItems:'center',fontWeight:'bold'}}>Y-axis:</Text>
              <Text>Average Dissolved Oxygen</Text>
              </View>             
            ):(null)}
              {(selectedTypeValue ===  'Average Ph Chart'|| selectedTypeValue ===  'Average TDS Chart' ||
              selectedTypeValue ===  'Average Temperature Chart'|| selectedTypeValue ===  'Motor Status Chart' || 
              selectedTypeValue ===  'Dissolved Oxygen' || selectedTypeValue ===   'Aerator Status Chart') 
              && selectedRangeValue === 'Past Week' ? (
        ...
        selectedTypeValue === 'Average Temperature Chart' || selectedTypeValue === 'Dissolved Oxygen Chart' ? (
         ...
         <View style={{backgroundColor:'#fff',alignItems:'center',justifyContent:'center',marginRight:-20}}>
          ...
          <View style={{marginBottom:1,marginHorizontal:wp('50%'),marginTop:hp('0.5%')}}>
