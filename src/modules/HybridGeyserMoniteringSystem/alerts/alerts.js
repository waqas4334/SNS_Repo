...
import { getAlerts } from '../../../redux/actions//hybridgeyserAction';
...
const AlertScreen = props => {
  ...
  const alert = useSelector(state => state.hybridgeyser.alerts);
  const AlertLoading = useSelector(state => state.hybridgeyser.alertLoading);
