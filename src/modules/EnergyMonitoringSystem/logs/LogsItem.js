        ...
        return(
          <View style={styles.container}>
              ...
              >
                ...
                <View style={{flexDirection: 'row'}}>
                  <Text style={styles.title} numberOfLines={1}>At: </Text>
            ...
            <View style={styles.container}>
              ...
              >
                <View style={{flexDirection: 'row'}}>
                  ...
                  <Text style={styles.valueText}> 
                    {
                      messagedata === 1 && title === 'doorstatus' ? ('Open') : 
                      messagedata === 0 && title === 'doorstatus' ? ('Close') : 
                      messagedata === 1 && title === 'genstatus' ? ('On') :
                      messagedata === 0 && title === 'genstatus' ? ('Off') : (messagedata) 
                    }
                  </Text>
                </View>
