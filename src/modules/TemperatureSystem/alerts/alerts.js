...
import { getAlerts} from '../../../redux/actions/tempAction';
...
const AlertScreen = (props) => {
  const {navigation} = props;
    ...
    const alerts = useSelector(state => state.Temperature.alerts);
    const alertLoading = useSelector(state => state.Temperature.alertLoading);
