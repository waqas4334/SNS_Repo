...
import { getAlerts } from '../../../redux/actions/geyserAction';
...
const AlertScreen = props => {
  ...
  const alert = useSelector(state => state.geyser.alerts);
  const AlertLoading = useSelector(state => state.geyser.alertLoading);
