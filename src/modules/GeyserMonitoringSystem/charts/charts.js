...
import { getCharts, getSensors } from '../../../redux/actions/geyserAction';
        ...
        {selectedTypeValue === null ? (
          ...
          <View style={styles.chartInnerView}>
            ...
            <Icon name='dot-single' size={30} color='#2196f3'/>
                        ...
                        <Text style={[styles.grayText,{marginTop:7, marginLeft: 7}]}>
                        {selectedTypeValue === "Temperature" ? "Temperature" : selectedTypeValue === "Burner Status" ? "Burner Status" : selectedTypeValue === "Geyser Status" ? "Geyser Status" : null}
                        </Text>
